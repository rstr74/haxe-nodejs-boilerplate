...
Math.__name__ = ["Math"];
var MyTest = function() { };
$hxClasses["MyTest"] = MyTest;
MyTest.__name__ = ["MyTest"];
MyTest.main = function() {
...
$hxClasses["TestFoo"] = TestFoo;
TestFoo.__name__ = ["TestFoo"];
TestFoo.__super__ = haxe_unit_TestCase;
TestFoo.prototype = $extend(haxe_unit_TestCase.prototype,{
	str: null
	,setup: function() {
		this.str = "foo";
	}
	,testSetup: function() {
		this.assertEquals("foo",this.str,{ fileName : "TestFoo.hx", lineNumber : 9, className : "TestFoo", methodName : "testSetup"});
	}
	,testAnotherSetup: function() {
		this.assertEquals("foo",this.str,{ fileName : "TestFoo.hx", lineNumber : 13, className : "TestFoo", methodName : "testAnotherSetup"});
	}
	,__class__: TestFoo
});
